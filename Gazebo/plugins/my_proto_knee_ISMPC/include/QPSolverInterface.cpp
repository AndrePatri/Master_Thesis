...
inline Eigen::VectorXf solveQP_hpipm(Eigen::MatrixXf costFunctionH, Eigen::VectorXf costFunctionF, Eigen::MatrixXf Aeq, Eigen::VectorXf beq, Eigen::MatrixXf AConstraint, Eigen::VectorXf bZMPMin, Eigen::VectorXf bZMPMax) {
    ...
    Eigen::VectorXf u_store = Eigen::VectorXf::Zero(nu_max);
